...
package object js {
  ...
  private[js] def newJavascriptEngine(): javax.script.ScriptEngine = newEngine("javascript")
  private[js] def newEngine(name: String): javax.script.ScriptEngine = scriptEngineMgr.getEngineByName(name)
